...
from .views import my_view,my_recaptha,signup,UserLoginView,PasswordResetRequestView,PasswordResetView,ShowAppointmentsView,CreateAppointmentView,GetDoctorsView,delete_doctor,Mark
...
urlpatterns=[
 ...
 # path('showappointments/',show_appointments,name='appointments'),
  path('showappointment/',ShowAppointmentsView.as_view(),name='appointments'),
  path('createappointment/',CreateAppointmentView.as_view(),name="create"),
